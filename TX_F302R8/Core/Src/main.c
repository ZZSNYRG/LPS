...
/* Definitions for rcvData */
osThreadId_t rcvDataHandle;
const osThreadAttr_t rcvData_attributes = {
  .name = "rcvData",
  .stack_size = 128 * 4,
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
static const uint8_t queueLen = 1;
//static QueueHandle_t coords;
uint8_t buffer[8];
uint8_t payload[6];
uint64_t txPipeAddrs = 0x11223344AA;
//char ackPayload[32];
char formattedPayload[32];
/* USER CODE END 0 */
...
/* USER CODE BEGIN Header_StartRcvData */
/**
* @brief Function implementing the rcvData thread.
* @param argument: Not used
* @retval None
*/
